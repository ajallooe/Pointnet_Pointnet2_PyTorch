...
class get_model(nn.Module):
    ...
    def forward(self, xyz, cls_label):
        ...
        one_hot_feat = torch.zeros(B, num_object_categories, device=cls_label.device, dtype=torch.float) # Ensure float
        one_hot_feat.scatter_(1, cls_label.long().unsqueeze(-1), 1) # cls_label to long for scatter
